        ...
        <div className="mb-4 text-center">
          ...
          <Grid item md={11} lg={10} className="mx-auto">
            <p className="text-second opacity-6 mt-3 mb-5 font-size-xxl">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum dolorem eos eveniet, exercitationem impedit magni molestias nihil nulla odio quas quasi, reprehenderit veritatis vitae? Corporis doloribus eius repellendus totam voluptate.
            </p>
          </Grid>
        </div>
