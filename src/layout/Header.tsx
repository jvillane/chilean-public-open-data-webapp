...
export const Header: React.FC<Props> = ({long}) => {
  const [collapse, setCollapse] = useState(false);
  const toggle = () => setCollapse(!collapse);

  return (
    <header className={"hero-wrapper bg-composed-wrapper bg-" + (long ? "night-sky" : "white")}>
      <div className="header-top-section pb-2">
        <Container>
          <div
            className={"p-2 header-nav-wrapper header-nav-wrapper-xl rounded-bottom px-4 " + (long ? "bg-white-5 navbar-dark" : "bg-white shadow-xxl navbar-light")}>
            <div className="app-nav-logo">
              <NavLink
                to="/"
                title="Open Data Chile"
                className={"app-nav-logo app-nav-logo--" + (long ? "light" : "dark")}>
                <div className={"app-nav-logo--icon shadow-second-sm border-0 bg-" + (long ? "secondary" : "deep-sky")}>
                  <img
                    alt="Open Data Chile"
                    src={projectLogo}
                  />
                    ...
                    <div className="shadow-lg w-100 bg-deep-sky p-4 rounded">
                      <List component="div" className="nav-pills nav-transparent nav-pills-rounded flex-column">
                        <ListItem
                          button
                          onClick={() => {
                            window.open('https://politics.open-data.cl', '_blank');
                          }}
                ...
                <Grid item lg={6}>
                  <div className="pt-3 text-white pt-xl-5 pr-0 pr-xl-5">
                    ...
                    <p className="font-size-xl py-3 text-white-50">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae fugit itaque numquam odio
                      officiis!
              ...
              <Grid container spacing={6}>
                <Grid item lg={4}>
                  <Card className="shadow-xxl card-box-hover-rise mb-5">
                    <div className="d-flex align-items-center p-4">
                      <div
                        className="d-50 text-white d-flex align-items-center justify-content-center rounded-pill bg-first shadow-xxl mr-3">
                        <FontAwesomeIcon
                          icon={['fas', 'suitcase']}
                ...
                <Grid item lg={4}>
                  <Card className="shadow-xxl card-box-hover-rise mb-5">
                    <div className="d-flex align-items-center p-4">
                      <div
                        className="d-50 text-white d-flex align-items-center justify-content-center rounded-pill bg-success shadow-xxl mr-3">
                        <FontAwesomeIcon
